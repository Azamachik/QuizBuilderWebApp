...
const mockQuestions = [
    {
        ...
        options: [
            ...
            { id: 'c', text: 'Первое и последнее запоминается лучше', isCorrect: false }
        ]
    },
    {
        id: 'q2',
...
export const Error: Story = {
    decorators: [
        StoreDecorator(
            {
                user: { authData: undefined, _inited: true },
                inviteLink: { isLoading: false, error: 'Ссылка недействительна или тест не опубликован' } as never,
                attempt: { isLoading: false, isSubmitting: false, sessionQuestions: [] } as never
            },
            { inviteLink: inviteLinkReducer, attempt: attemptReducer }
        )
        ...
        StoreDecorator(
            {
                user: { authData: undefined, _inited: true },
                inviteLink: {
                    session: { inviteLink: mockLink, quiz: { ...mockQuiz, questionsCount: 0 }, questions: [] },
                    isLoading: false
                } as never,
                attempt: { isLoading: false, isSubmitting: false, sessionQuestions: [] } as never
            },
