            ...
            <div className='w-full max-w-[400px] space-y-7'>
                ...
                <form onSubmit={handleSubmit} className='space-y-3'>
                    ...
                    <div className='space-y-1.5'>
                        ...
                        <input type='password' className={inputClass} value={form.confirm} onChange={handleChange('confirm')} required />
                    </div>
                    <Button type='submit' variant='action' className='mt-2 h-12 w-full rounded-2xl text-sm font-semibold'>
                        Зарегистрироваться
                    </Button>
                </form>
